...
public class SanchayUserSlimDTOToSanchayUserMap extends PropertyMap<SanchayUserSlimDTO, SanchayUser> {
    private SanchayDeepModelMapper modelMapper;

    public SanchayUserSlimDTOToSanchayUserMap(SanchayDeepModelMapper modelMapper)
    {
        super();
